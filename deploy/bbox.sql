-- Deploy load_brasil_osm:bbox to pg
-- requires: linestring
...
BEGIN;
	...
	-- indexing the location of the way.  This will contain a bounding box
	-- surrounding the extremities of the way.
	...
	-- Create an aggregate function that always returns the first non-NULL
	-- item.  This is required for bbox queries.
